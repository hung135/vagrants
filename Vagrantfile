...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ubuntusandbox"
...
group: "_apt"
    ...
    config.vm.provision "shell", inline: <<-SHELL
     ...
     sudo apt-get install git samba sqitch cookiecutter jq -y --allow-unauthenticated
...
sudo echo "path = /home/ubuntu/">>/etc/samba/smb.conf
